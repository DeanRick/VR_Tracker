...
public:
    SPIImpl(SlimeVR::DirectSPIInterface* spi, ::PinInterface* csPin)
    ...
    bool hasSensorOnBus() override { return m_spi != nullptr; }
    std::string toString() const override { return "SPI"; }
